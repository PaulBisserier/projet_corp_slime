    ...
    <main>
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="partenaire" class="col-lg-5 p-2 mx-2">
                    <h2 class="text-success">Nos partenaires</h2>
                ...
                <div class="col-lg-5  p-2 mx-2">
                    ...
                    <div class="input-group pt-5">
                        ...
                        <div class="form-check mx-auto pt-3">
                            <input id="don-checkbox" type="checkbox" class="form-check-input">
                            <label class="form-check-label">Veuillez accepter pour valider votre don</label>
                        </div>
                    </div>
